...
class HTMLRenderer {
  ...
  constructor(element) {
    if (element instanceof Element) {
      ...
      throw new Error(
        "Invalid element argument given to HTMLRenderer (must be a selector or an Element)"
      );
    }
  ...
  resolveSelector(selector) {
    ...
    if (element === null) {
      throw new Error(
        "Invalid element argument given to HTMLRenderer (selector resolved no elements)"
      );
    } else {
      return element;
    }
